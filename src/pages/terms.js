  ...
  <Layout>
    ...
    <div className={"container"}>
      <div className={"content"}>
        ...
        <h3>Welcome to Maxx1Biz!</h3>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of PT. MAXX1BIZ INDONESIA BERJAYA's Website, located at
          https://maxx1biz.net/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Maxx1Biz if you do not agree to
        ...
        <p>
          We employ the use of cookies. By accessing Maxx1Biz, you agreed to use
          cookies in agreement with the PT. MAXX1BIZ INDONESIA BERJAYA's Privacy
          Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, PT. MAXX1BIZ INDONESIA BERJAYA and/or its
          licensors own the intellectual property rights for all material on
          Maxx1Biz. All intellectual property rights are reserved. You may
          access this from Maxx1Biz for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>1. Republish material from Maxx1Biz</li>
          <li>2. Sell, rent or sub-license material from Maxx1Biz</li>
          <li>3. Reproduce, duplicate or copy material from Maxx1Biz</li>
          <li>4. Redistribute content from Maxx1Biz</li>
        </ul>
        ...
        <p>
          ...
          exchange opinions and information in certain areas of the website. PT.
          MAXX1BIZ INDONESIA BERJAYA does not filter, edit, publish or review
          Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of PT. MAXX1BIZ INDONESIA BERJAYA,its
          ...
          by applicable laws, PT. MAXX1BIZ INDONESIA BERJAYA shall not be liable
        ...
        <p>
          PT. MAXX1BIZ INDONESIA BERJAYA reserves the right to monitor all
        ...
        <p>
          You hereby grant PT. MAXX1BIZ INDONESIA BERJAYA a non-exclusive
        ...
        <ul>
          ...
          <li>
            3. Online directory distributors may link to our Website in the same
            manner as they hyperlink to the Websites of other listed businesses;
            and
          </li>
          <li>
            4. System wide Accredited Businesses except soliciting non-profit
        ...
        <p>
          ...
          the hyperlink compensates the absence of PT. MAXX1BIZ INDONESIA
          BERJAYA; and (d) the link is in the context of general resource
          information.
        </p>
        ...
        <p>
          ...
          sending an e-mail to PT. MAXX1BIZ INDONESIA BERJAYA. Please include
        ...
        <p>
          No use of PT. MAXX1BIZ INDONESIA BERJAYA's logo or other artwork will
